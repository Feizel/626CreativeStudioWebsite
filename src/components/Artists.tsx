  ...
  const artists = [
    {
      ...
      videos: [
        {
          title: "No Way (Official Video)",
          thumbnail:
            "https://images.pexels.com/photos/1763075/pexels-photo-1763075.jpeg?auto=compress&cs=tinysrgb&w=400",
        },
        {
          title: "Fosho (Live Performance)",
          thumbnail:
    ...
    },
    {
      ...
      videos: [
        {
          title: "VIZA (Official Video)",
          thumbnail:
            "https://images.pexels.com/photos/1190298/pexels-photo-1190298.jpeg?auto=compress&cs=tinysrgb&w=400",
        },
        {
          title: "Oh Babe(Acoustic)",
          thumbnail:
    ...
    },
    {
      ...
      videos: [
        ...
        {
          title: "Put in the Work & Step (Behind the Scenes)",
          thumbnail:
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-12">
            <div>
              <div className="relative overflow-hidden rounded-lg mb-6">
                ...
                />
                <div
                  className={`absolute inset-0 bg-gradient-to-t ${currentArtist.color} opacity-20`}
                ></div>
              </div>
            </div>
            ...
            <div>
              ...
              <p
                className={`text-xl font-semibold mb-4 bg-gradient-to-r ${currentArtist.color} bg-clip-text text-transparent`}
              >
                {currentArtist.genre}
              </p>
              ...
              <div className="flex space-x-4">
                <button
                  className={`bg-gradient-to-r ${currentArtist.color} text-white px-6 py-3 rounded-lg font-semibold hover:opacity-90 transition-opacity flex items-center space-x-2`}
                >
                  <Play size={20} />
                ...
                {currentArtist.tracks.map((track, index) => (
                  ...
                  >
                    <div className="flex items-center space-x-3">
                      <button
                        className={`w-10 h-10 rounded-full bg-gradient-to-r ${currentArtist.color} flex items-center justify-center hover:scale-110 transition-transform`}
                      >
